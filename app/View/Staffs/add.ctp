...
<script
	src="/js/src/load-image.all.min.js"></script>
<!-- The Canvas to Blob plugin is included for image resizing functionality -->
<script
	src="/js/src/canvas-to-blob.min.js"></script>
...
<div class="container">
	<div class="tab-v1">
		<ul class="nav nav-tabs">
			<li class="active"><a href="#home-1" data-toggle="tab">Add New Staff</a></li>
...
<?php echo $this->Form->create('Staff',array('class' => 'sky-form') ); ?>
		...
		<fieldset>
			...
			<div class="row">
				...
				<section class="col col-4">
					<label class="label">Skill Japanese (<span id="japanese">0</span>)
				...
				<section class="col col-4">
					<label class="label">Skill English (<span id="english">0</span>)
					</label>
					<?php
				...
				<section class="col col-4">
					<label class="label">Skill Vietnamese (<span id="vietnamese">0</span>)
					</label>
					<?php
			...
			<div class="row">
				<section class="col col-4">
					<label class="label">HTML/CSS (<span id="htmlcss">0</span>)
					</label>
					<?php
				...
				<section class="col col-4">
					<label class="label">JavaScript(<span id="javascript">0</span>)
					</label>
					<?php
				...
				<section class="col col-4">
					<label class="label">PHP (<span id="php">0</span>)
					</label>
					<?php
			...
			<div class="row">
				<section class="col col-6">
					<label class="label">NODE.JS (<span id="nodejs">0</span>)
					</label>
					<?php
				...
				<section class="col col-6">
					<label class="label">LINUX (<span id="linux">0</span>)
					</label>
					<?php
		...
		<div id="content">
			...
			<h4 class="color-green">Please chose your avatar</h4>
...
// 2, save img for DB 
     ...
     // Enable image resizing, except for Android and Opera,
		...
		<hr>
		<h4>If you don't want to create staff. Please <?php echo $this->Html->link('come back',array('controller'=>'staffs','action'=>'index'))?> 
