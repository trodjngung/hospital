...
<div class="page-head">
	...
	<ol class="breadcrumb">
		<li><a href="/user">Bảng mô tả</a></li>
...
<?php if($patient['Patient']['gioitinh']=='nu'){$src='/img/hospital/benhnhannu.png';}else{$src='/img/hospital/benhnhannam.png';} ?>
						<img src="<?php echo $src;?>" width="80%"
							alt="profile picture">
					</div>
<br><br>
				...
				<div class="col-sm-8 col-md-8">
					<div class="table-responsive">
						<table class="table table-striped table-fw-widget table-hover">
							<tbody>
								<tr>
									<td align="right" width="30%"><center>Họ và tên</center></td>
									<td width="70%"><b><?php echo $patient['Patient']['hoten'];?></b></td>
								</tr>
								<tr>
									<td align="right"><center>Ngày sinh</center></td>
									<td><?php echo $patient['Patient']['ngaysinh'];?></td>
								</tr>
								<tr>
									<td align="right"><center>Số điện thoại</center></td>
									<td><?php echo $patient['Patient']['phone'];?></td>
								</tr>
								<tr>
									<td align="right"><center>Giới tính</center></td>
									<td><?php echo $patient['Patient']['gioitinh'];?></td>
								</tr>
								<tr>
									<td align="right"><center>Lý do khám</center></td>
									<td><?php echo $patient['Patient']['lydo'];?></td>
								</tr>
								<tr>
									<td align="right"><center>Địa chỉ</center></td>
									<td><?php echo $patient['Patient']['diachi'];?></td>
								</tr>
								<tr>
									<td align="right"><center>Bác sỹ</center></td>
									<td><?php echo $patient['Patient']['bacsy'];?></td>
								</tr>
								<tr>
									<td align="right"><center>Kỹ thuật viên</center></td>
									<td><?php echo $patient['Patient']['kythuat'];?></td>
								</tr>
								<tr>
									<td align="right"><center>Những hạng mục khám</center></td>
						...
						<script type="text/javascript"
							src="/js/hospital/jquery/jquery.min.js"></script>
						<script type="text/javascript"
							src="/js/hospital/bootstrap/bootstrap.min.js"></script>
						<div class="row">
							<div class="col-sm-6 alignRight mgt20 mgbt20">
								<button type="submit" class="btn btn-primary" id="myBtn">In ra
									kết luận</button>
							</div>
							<div class="col-sm-6 alignLeft mgt20 mgbt20">
								<button type="submit" class="btn btn-primary">Quay lại để chỉnh
									sửa</button>
							</div>
						</div>
					</div>
	...
	<div class="modal fade" id="myModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog modal-full" role="document">
			<div class="modal-content">
				<form method="POST"
					action="http://pmsoi.hoster.vn/admin/analysis/ultrasound/conclude/44"
					accept-charset="UTF-8" enctype="multipart/form-data">
					<input name="_token" type="hidden"
						value="Cn8IAYDO1dHfLu4g75JNN8pc663pwgdzBlAS3qTt">
						...
						<div class="row">
							<div class="col-xs-7">
								<div class="form-group">
									<label>Chọn mấu</label> <select class="form-control template"
										data-target="editor1000">
										<option value="">Chọn mẫu</option>
										<option value="<table    border=&quot;1&quot;
											cellpadding=&quot;1&quot; cellspacing=&quot;1&quot;
											style="width: =" " 700px&amp;quot;"="">Kết luận - - &nbsp;
											"&gt;Soi Trĩ</option>
										<option value="<p><span style="font-size: ="
												" 16px&amp;quot;"="">Soi cổ tử cung bình thường &nbsp;


												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Cổ tử cung không
												viêm. Không thấy hình ảnh tổn thương nghi ngờ. Lugol bắt màu
												đều. &nbsp; &nbsp; "&gt;Soi Cổ Tử Cung Bình Thường </option>
										<option value="<p><span style="font-size: ="
												" 16px&amp;quot;"="">Viêm lộ tuyến CTC &nbsp;


												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												???&nbsp; Có Thể gặp những Nguy hiểm sau : 1/ Một số
												tạng&nbsp; đã cắt hết hay cắt bán phần, có khi teo, lạc chỗ,



												&nbsp;&nbsp;&nbsp;&nbsp; không có bẩm sinh... lại&nbsp; nói
												còn nguyên, còn đẹp !!! 2/ Bên trái&nbsp; chẩn đoán hay đánh
												máy thành bên Phải??? 3/ Bộ phận của Nam, Nữ đánh lộn sang
												nhau??? 4/ Không&nbsp; ghi rõ&nbsp; kích thuớc, thể tích, cứ
												để trống ở tờ in ?? &nbsp;&nbsp;&nbsp;&nbsp;
												_____________________________________ &nbsp;Cổ tử cung có
												hình ảnh lộ tuyến&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; cm môi
												trước,&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; cm môi sau Có tái tạo
												cửa tuyến, đảo tuyến. Lugol âm tính vùng tổn thương. &nbsp;

												&nbsp; "&gt;Viên lộ tuyến CTC </option>
									</select>
								</div>
					...
					<div class="shadow-effect-2">
						<img src="<?php echo $src; ?>" width="80%" alt="profile picture">
					</div>
<p> Bệnh nhân :<b> <?php echo $patient['Patient']['hoten']; ?> </b></p>
				</div>
								<!-- End Image -->
							<div class="col-xs-12">
								<input name="analysis_id" type="hidden" value="1000">
								<div class="form-group">
									<label>Mô tả<span class="required" aria-required="true">*</span></label>
									<!-- Editer  -->
									<!--
										...
										-->
											...
											<div class="main-content">
												<div class="email editor">
													<div id="email-editor" style="display: none;">
														<p>Hello,</p>
													...
													<div class="note-editor panel panel-default">
															...
															<div class="note-image-dialog modal" aria-hidden="false">
																<div class="modal-dialog">
																	<div class="modal-content">
																		...
																		<div class="modal-body">
																			<div
																				class="form-group row note-group-select-from-files">
																		...
																		<div class="modal-body">
																			<div class="form-group row">
																				<label>Text to display</label><input
																					class="note-link-text form-control col-md-12"
																					type="text">
																			</div>
																			<div class="form-group row">
																				<label>To what URL should this link go?</label><input
																					class="note-link-url form-control col-md-12"
																					type="text" value="http://">
																			</div>
																			<div class="checkbox">
																				<label><input type="checkbox" checked=""> Open in
																					new window</label>
																			</div>
																		</div>
																		<div class="modal-footer">
														...
														<div class="note-toolbar panel-heading">
															<div class="note-style btn-group">
																<div class="btn-group" data-name="style">
																	...
																	<ul class="dropdown-menu">
																		...
																		<li><a data-event="formatBlock" href="#"
																			data-value="h2"><h2>Header 2</h2></a></li>
																		<li><a data-event="formatBlock" href="#"
																			data-value="h3"><h3>Header 3</h3></a></li>
																		<li><a data-event="formatBlock" href="#"
																			data-value="h4"><h4>Header 4</h4></a></li>
																		<li><a data-event="formatBlock" href="#"
																			data-value="h5"><h5>Header 5</h5></a></li>
																		<li><a data-event="formatBlock" href="#"
																			data-value="h6"><h6>Header 6</h6></a></li>
																	</ul>
																</div>
															</div>
															<div class="note-font btn-group">
																<button type="button" class="btn btn-default" title=""
																	data-event="bold" tabindex="-1" data-name="bold"
																	data-original-title="Bold (⌘+B)">
																	<i class="fa fa-bold"></i>
																</button>
																<button type="button" class="btn btn-default" title=""
																	data-event="italic" tabindex="-1" data-name="italic"
															...
															<div class="note-fontname btn-group">
																<div class="btn-group note-fontname"
																	data-name="fontname">
																	<button type="button"
																		class="btn btn-default dropdown-toggle"
																		data-toggle="dropdown" title="" tabindex="-1"
																		...
																		aria-expanded="false">
																		<span class="note-current-fontname">Open Sans</span> <span
																			class="caret"></span>
																	</button>
																	<ul class="dropdown-menu note-check">
																		<li><a data-event="fontName" href="#"
																			data-value="Arial" style="font-family: 'Arial'"
																			class=""><i class="fa fa-check"></i> Arial</a></li>
																		<li><a data-event="fontName" href="#"
																			data-value="Arial Black"
																			style="font-family: 'Arial Black'" class=""><i
																				class="fa fa-check"></i> Arial Black</a></li>
																		<li><a data-event="fontName" href="#"
																			data-value="Comic Sans MS"
																			style="font-family: 'Comic Sans MS'" class=""><i
																				class="fa fa-check"></i> Comic Sans MS</a></li>
																		<li><a data-event="fontName" href="#"
																			data-value="Courier New"
																			style="font-family: 'Courier New'" class=""><i
																				class="fa fa-check"></i> Courier New</a></li>
																		<li><a data-event="fontName" href="#"
																			data-value="Helvetica Neue"
																			style="font-family: 'Helvetica Neue'" class=""><i
																				class="fa fa-check"></i> Helvetica Neue</a></li>
																		<li><a data-event="fontName" href="#"
																			data-value="Helvetica"
																			style="font-family: 'Helvetica'" class=""><i
																				class="fa fa-check"></i> Helvetica</a></li>
																		<li><a data-event="fontName" href="#"
																			data-value="Impact" style="font-family: 'Impact'"
																			class=""><i class="fa fa-check"></i> Impact</a></li>
																		<li><a data-event="fontName" href="#"
																			data-value="Lucida Grande"
																			style="font-family: 'Lucida Grande'" class=""><i
																				class="fa fa-check"></i> Lucida Grande</a></li>
																		<li><a data-event="fontName" href="#"
																			data-value="Tahoma" style="font-family: 'Tahoma'"
																			class=""><i class="fa fa-check"></i> Tahoma</a></li>
																		<li><a data-event="fontName" href="#"
																			data-value="Times New Roman"
																			style="font-family: 'Times New Roman'" class=""><i
																				class="fa fa-check"></i> Times New Roman</a></li>
																		<li><a data-event="fontName" href="#"
																			data-value="Verdana" style="font-family: 'Verdana'"
																			class=""><i class="fa fa-check"></i> Verdana</a></li>
																	</ul>
																</div>
															</div>
															<div class="note-fontsize btn-group">
																<div class="btn-group note-fontsize"
																	data-name="fontsize">
																	<button type="button"
																		class="btn btn-default dropdown-toggle"
																		data-toggle="dropdown" title="" tabindex="-1"
																		data-original-title="Font Size">
																		<span class="note-current-fontsize">13</span> <span
																			class="caret"></span>
																	</button>
																	<ul class="dropdown-menu note-check">
																		<li><a data-event="fontSize" href="#" data-value="8"
																			class=""><i class="fa fa-check"></i> 8</a></li>
																		<li><a data-event="fontSize" href="#" data-value="9"
																			class=""><i class="fa fa-check"></i> 9</a></li>
																		<li><a data-event="fontSize" href="#" data-value="10"
																			class=""><i class="fa fa-check"></i> 10</a></li>
																		<li><a data-event="fontSize" href="#" data-value="11"
																			class=""><i class="fa fa-check"></i> 11</a></li>
																		<li><a data-event="fontSize" href="#" data-value="12"
																			class=""><i class="fa fa-check"></i> 12</a></li>
																		<li><a data-event="fontSize" href="#" data-value="14"
																			class=""><i class="fa fa-check"></i> 14</a></li>
																		<li><a data-event="fontSize" href="#" data-value="18"
																			class=""><i class="fa fa-check"></i> 18</a></li>
																		<li><a data-event="fontSize" href="#" data-value="24"
																			class=""><i class="fa fa-check"></i> 24</a></li>
																		<li><a data-event="fontSize" href="#" data-value="36"
																			class=""><i class="fa fa-check"></i> 36</a></li>
																	</ul>
																</div>
															</div>
															<div class="note-color btn-group">
																<button type="button"
																	class="btn btn-default note-recent-color" title=""
																	data-event="color"
																	data-value="{&quot;backColor&quot;:&quot;yellow&quot;}"
																	tabindex="-1" data-name="color"
															...
															<div class="note-para btn-group">
																...
																<div class="btn-group" data-name="paragraph">
																	<button type="button"
																		...
																		<i class="fa fa-align-left"></i> <span class="caret"></span>
																	</button>
																	<div class="dropdown-menu">
																		<div class="note-align btn-group">
																			<button type="button" class="btn btn-default active"
																				title="" data-event="justifyLeft" tabindex="-1"
															...
															<div class="note-height btn-group">
																<div class="btn-group" data-name="height">
																	...
																	<ul class="dropdown-menu note-check">
																		<li><a data-event="lineHeight" href="#" data-value="1"
																			class=""><i class="fa fa-check"></i> 1.0</a></li>
																		<li><a data-event="lineHeight" href="#"
																			data-value="1.2" class=""><i class="fa fa-check"></i>
																				1.2</a></li>
																		<li><a data-event="lineHeight" href="#"
																			data-value="1.4" class=""><i class="fa fa-check"></i>
																				1.4</a></li>
																		<li><a data-event="lineHeight" href="#"
																			data-value="1.5" class=""><i class="fa fa-check"></i>
																				1.5</a></li>
																		<li><a data-event="lineHeight" href="#"
																			data-value="1.6" class="checked"><i
																				class="fa fa-check"></i> 1.6</a></li>
																		<li><a data-event="lineHeight" href="#"
																			data-value="1.8" class=""><i class="fa fa-check"></i>
																				1.8</a></li>
																		<li><a data-event="lineHeight" href="#" data-value="2"
																			class=""><i class="fa fa-check"></i> 2.0</a></li>
																		<li><a data-event="lineHeight" href="#" data-value="3"
																			class=""><i class="fa fa-check"></i> 3.0</a></li>
																	</ul>
																</div>
															</div>
															...
															<div class="note-insert btn-group">
																<button type="button" class="btn btn-default" title=""
																	data-event="showLinkDialog" data-hide="true"
																	tabindex="-1" data-name="link"
																	data-original-title="Link (⌘+K)">
																	<i class="fa fa-link"></i>
																</button>
																<button type="button" class="btn btn-default" title=""
																	data-event="showImageDialog" data-hide="true"
																	tabindex="-1" data-name="picture"
																...
																<button type="button" class="btn btn-default" title=""
																	...
																	data-name="hr"
																	data-original-title="Insert Horizontal Rule (⌘+ENTER)">
															...
															<div class="note-view btn-group">
																...
																<button type="button" class="btn btn-default" title=""
																	...
																	data-name="codeview" data-original-title="Code View">
																	<i class="fa fa-code"></i>
																</button>
															</div>
															<div class="note-help btn-group">
																<button type="button" class="btn btn-default" title=""
																	data-event="showHelpDialog" data-hide="true"
																	tabindex="-1" data-name="help"
														...
														<div class="note-editing-area">
																	...
																	<div class="popover-content">
																		...
																		<div class="btn-group">
																			<button type="button" class="btn btn-default btn-sm"
																				...
																				tabindex="-1" data-original-title="Float Left">
																				<i class="fa fa-align-left"></i>
																			</button>
																			<button type="button" class="btn btn-default btn-sm"
																				title="" data-event="floatMe" data-value="right"
																				tabindex="-1" data-original-title="Float Right">
																				<i class="fa fa-align-right"></i>
																			</button>
																			<button type="button" class="btn btn-default btn-sm"
																				title="" data-event="floatMe" data-value="none"
																				tabindex="-1" data-original-title="Float None">
																				<i class="fa fa-align-justify"></i>
																			</button>
																		</div>
																		<br>
																		<div class="btn-group">
																			<button type="button" class="btn btn-default btn-sm"
																				title="" data-event="imageShape"
																				data-value="img-rounded" tabindex="-1"
																				data-original-title="Shape: Rounded">
																				<i class="fa fa-square"></i>
																			</button>
																			<button type="button" class="btn btn-default btn-sm"
																				title="" data-event="imageShape"
																				data-value="img-circle" tabindex="-1"
																				data-original-title="Shape: Circle">
																				<i class="fa fa-circle-o"></i>
																			</button>
																			<button type="button" class="btn btn-default btn-sm"
																				title="" data-event="imageShape"
																				data-value="img-thumbnail" tabindex="-1"
																				data-original-title="Shape: Thumbnail">
																				<i class="fa fa-picture-o"></i>
																			</button>
																			<button type="button" class="btn btn-default btn-sm"
																				title="" data-event="imageShape" tabindex="-1"
																				data-original-title="Shape: None">
															...
															<div class="note-editable panel-body"
																contenteditable="true" style="height: 500px;">
																<p>
																	<span style="font-family: Arial;">Nhập kết quả </span>
																</p>
																<p>
							...
							<div class="col-xs-12">
								<div class="modal-footer">
									...
									<button type="submit" name="print" value="print"
										class="btn btn-primary" id = "print">Lưu &amp; in</button>
									<button type="button" class="btn btn-default"
