      ...
      <div class="widget widget-fullwidth widget-small">
        <div class="widget-head">
          <?php echo $this->Form->create('Patient', array('class' => 'form-horizontal')); ?>
            <div class="row">
              <div class="col-sm-6">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input name="data[Patient][hoten]" placeholder="Tên bệnh nhân " class="form-control" type="text" id="PatientLastName">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input name="data[Patient][ngaysinh]" placeholder="Ngày/tháng/năm" class="form-control" type="date" id="PatientBrithday">
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputAddress" class="col-sm-3 control-label">Số điện thoại </label>
                  <div class="col-sm-9">
                    <input name="data[Patient][phone]" placeholder="Số điện Thoại " class="form-control" type="text" id="PatientAddress">
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputAddress" class="col-sm-3 control-label">Địa chỉ </label>
                  <div class="col-sm-9">
                    <input name="data[Patient][diachi]" placeholder="Địa chỉ " class="form-control" type="text" id="PatientAddress">
                  </div>
                </div>
              </div>
              <div class="col-sm-6">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <textarea name="data[Patient][lydo]" class="form-control" rows="8" id="PatientMedicalReport"></textarea>
                  </div>
                </div>
                <!-- End lý do khám -->
              </div>
            ...
            <div class="row">
              <div class="col-sm-6 alignCenter mgt20 mgbt20">
