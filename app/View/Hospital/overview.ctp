		...
		<div class="col-md-6">
			<div class="widget widget-calendar">
				<div class="cal-container">
					<div class="cal-notes">
						<span class="day">Thứ 5</span><span class="date">Ngày 14 tháng 4</span><span
							class="title">Chú ý<span class="icon s7-plus"></span></span>
						<ul>
							<li><span class="hour">14h</span><span class="event-name">Tiếp
									bệnh nhân A</span></li>
							<li><span class="hour">8h</span><span class="event-name">Gặp Nha
									Sĩ C</span></li>
						</ul>
					</div>
					...
					<div class="cal-calendar">
						<div class="ui-datepicker hasDatepicker" id="dp1460614637890">
							<div
								...
								<div
									...
									<div class="ui-datepicker-title">
										<span class="ui-datepicker-month">April</span>&nbsp;<span
									...
									<tbody>
										<tr>
											...
											<td class=" " data-handler="selectDay" data-event="click"
												data-month="3" data-year="2016"><a class="ui-state-default"
												href="#">1</a></td>
											<td class=" ui-datepicker-week-end " data-handler="selectDay"
												data-event="click" data-month="3" data-year="2016"><a
		...
		<div class="col-md-3">
			<div class="widget widget-weather">
				<div class="wt-container">
					<div class="wt-hour">
						<span class="hour">2:45</span><span class="meridian">PM</span>
					</div>
					<div class="wt-info">
						<div class="wt-day">
							<span class="day">Hôm nay</span>
							<canvas height="35" width="55" class="icon1"></canvas>
							<span class="date">30°/28°</span>
						</div>
						<div class="wt-day">
							<span class="day">Ngày Mai</span>
							<canvas height="35" width="45" class="icon2"></canvas>
							<span class="date">28°/25°</span>
						</div>
						<div class="wt-day">
							<span class="day">Ngày Kia</span>
							<canvas height="35" width="45" class="icon3"></canvas>
							<span class="date">23°/18°</span>
						</div>
					</div>
					<div class="wt-location">
						<span class="icon s7-map-marker"></span><span class="city">Hà Nội</span>
					</div>
				</div>
			</div>
		</div>
		<div class="col-md-3">
			<div class="widget widget-download-list">
				<div class="widget-head">
					<span class="icon s7-cloud"></span><span class="title">Tải Mẫu</span>
				</div>
				<ul class="widget-list">
					<li><a href="#">Mẫu Xét Nghiệm<span class="icon s7-download"></span></a></li>
					<li><a href="#">Mẫu Khai<span class="icon s7-download"></span></a></li>
					<li><a href="#">Mẫu trả kết quả<span class="icon s7-download"></span></a></li>
					<li><a href="#">Mẫu bệnh cấp tính<span class="icon s7-download"></span></a></li>
				</ul>
			</div>
		</div>
	</div>
